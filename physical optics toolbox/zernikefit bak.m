...
% [Z, residual, rmsresidual, R] = zernikefit(x,y,f,n,R)
%
...
if isempty(P), P = zernikepolynomials('polar'); end

[x, y, f, n, R, fRes, nuse] = ValidateInputs(varargin{:});
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [x,y,f,n,R,fRes,nuse] = ValidateInputs(varargin)
% validate inputs
...
switch length(varargin),
    ...
    case 5,
        ...
        % now trim data to within circle of radius R
        nuse = rp <= R;
    otherwise,
        error('usage: [Z, normr] = zernikefit(x,y,f,n,R)');
end
