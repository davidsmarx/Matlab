...
module IDiffraction_Methods
  ...
  contains
    ...
    function $IDiffraction_ClearWavefront( pInterface ,&
             BeamID ,&
             status ) result (hresult)
        !DEC$ ATTRIBUTES STDCALL :: $IDiffraction_ClearWavefront
        use Diffraction_Types
        use dfcom
        use dflib
        implicit none
        ...
        hresult = IDiffraction_ClearWavefront(pInterface % pInternalData % pInstanceData ,&
             BeamID ,&
             status )
