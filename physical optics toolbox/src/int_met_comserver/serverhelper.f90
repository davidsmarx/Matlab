...
module ServerHelper
  ...
  contains
    ...
    function RegisterServer () result (r)
        ...
        bDual = .FALSE.
        bDual = .TRUE.
        status = RegisterClass(Diffraction_PROGID, Diffraction_VERSION, &
                    Diffraction_CLASS_NAME, Diffraction_THREADING_MODEL, &
                    CLSID_Diffraction, GUID_TypeLib_int_met_comserver, modname, &
                    bDual)
    ...
    function UnregisterServer () result (r)
        ...
        r = S_OK
        !  Per class
        status = UnregisterClass(Diffraction_PROGID, Diffraction_VERSION, &
                    CLSID_Diffraction)
        ...
        !  is installed
        !status = UnRegisterTypeLib(GUID_TypeLib_int_met_comserver, ...)
        !  Remove the \TYPELIB sub-keys
        call COMStringFromGUID(GUID_TypeLib_int_met_comserver, TypelibGUID, status)
