...
!============================
   ...
   TYPE, PUBLIC :: CornerCube
      PRIVATE
      REAL(pr) :: size                               ! Length of an edge
      ...
      REAL(pr), DIMENSION(:,:), POINTER :: fM0 => NULL()
...
CONTAINS
  ...
  != = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
   ...
   segVertex(:,1) =  cc%eM(1:2,1)
   segVertex(:,2) = -cc%eM(1:2,3)
   segVertex(:,3) =  cc%eM(1:2,2)
   segVertex(:,4) = -cc%eM(1:2,1)
   segVertex(:,5) =  cc%eM(1:2,3)
   segVertex(:,6) = -cc%eM(1:2,2)
   segVertex(:,7) = segVertex(:,1)
   DO k = 1,7
      segVertex(1,k) = (2.0_pr*cc%size)*segVertex(1,k) + cc%xc
      segVertex(2,k) = (2.0_pr*cc%size)*segVertex(2,k) + cc%yc
   END DO
  ...
  != = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
   ...
   ! Local variables
   REAL(pr), DIMENSION(SIZE(y),SIZE(x)) :: segOPD, OPD
   REAL(pr)                             :: const
