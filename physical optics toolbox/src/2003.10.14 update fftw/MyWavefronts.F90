...
!   PUBLIC :: CONJG
   ...
   TYPE, PUBLIC :: wavefront
      ...
      integer*4                             :: dummy1 ! for data alignment
   END TYPE wavefront
   !...........................................................................
...
CONTAINS
  ...
  != = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
   ...
   IF ( ASSOCIATED( beam%amp ) ) THEN
      ...
      beam%wavelength = 0.0_pr
      beam%curvature  = 0.0_pr
      DEALLOCATE( beam%amp, beam%x, beam%y )
   END IF
  ...
  != = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
   ...
   CONTAINS
     ...
     !- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      ...
      ELSE
         CALL CZT2D( beam%amp, beam%dy, beam%dx, dfy, dfx )
      END IF
...
!= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
   SUBROUTINE CreateWavefront( beam, field, dx, dy, lambda,  &
                             xc, yc, power )
  != = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
   ...
   TYPE(wavefront), INTENT(OUT)   :: beam
   ...
   ALLOCATE( beam%x(Nx), beam%y(Ny), beam%amp(Ny,Nx) )
...
!=======================================================================================
    SUBROUTINE GetWavefrontParameters(beam, beamamp, dx, dy, lambda, x, y, curv )

    IMPLICIT NONE

    TYPE(wavefront), INTENT(IN)   :: beam
    REAL(pr), INTENT(OUT)         :: dx, dy
    REAL(pr), INTENT(OUT)         :: lambda
    REAL(pr), INTENT(OUT)         :: curv
    REAL(pr), INTENT(OUT), ALLOCATABLE, DIMENSION(:) :: x, y
    COMPLEX(prc), INTENT(INOUT), ALLOCATABLE, DIMENSION(:,:) ::beamamp
    ...
    IF (ALLOCATED(beamamp)) THEN
        DEALLOCATE(beamamp)
    ENDIF
    ALLOCATE(beamamp(ny,nx))

    beamamp = GetWavefrontAmp(beam, nx, ny)


    END SUBROUTINE GetWavefrontParameters
