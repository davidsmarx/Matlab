function [ke, se, m2, ko] = uniaxial_raytracing_uniref(k1, n, c, m1, mo, me)
% [ke, se, m2, ko] = uniaxial_raytracing_uniref(k1, n, c, m1, mo, me)
% from Beyerle & McDermid paper
% k1, n, c are unit vectors of incident phase velocity, surface normal, axis orientation
% m1 = index of incident k1
