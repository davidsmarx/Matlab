 classdef CPupImAnalysis
    ...
    methods
        function S = CPupImAnalysis(imfn, varargin)
            ...
            % so that associated images can be cropped the same way
            S.iyuse = iyuse; 
            S.ixuse = ixuse;
        ...
        function Spsf = StrutDeconv(S, Sstrut, varargin)
            ...
            function theta = CalcEdgeAngle(xgr, ygr)
                ...
                ppx = polyfit(t, xgr, 1);
                ppy = polyfit(t, ygr, 1);
                theta = atan2(ppy(1), ppx(1)); % ppy(x) = dy/dt, so ppy/ppx = dy/dx
            end % CalcEdgeAngle
            ...
            Spsf = struct(...
                ...
                ,'xgrMaxLt', xgrMaxLt ...
                ,'ygrMaxLt', ygrMaxLt ...
                ,'thgrMaxLt', CalcEdgeAngle(xgrMaxLt, ygrMaxLt) ...
                ,'grMaxRt', grMaxRt ...
                ,'xgrMaxRt', xgrMaxRt ...
                ,'ygrMaxRt', ygrMaxRt ...
                ,'thgrMaxRt', CalcEdgeAngle(xgrMaxRt, ygrMaxRt) ...
                ,'fwhmlt', fwhmlt ...
                ,'fwhmrt', fwhmrt ...
                ,'dhalflt', dhalflt ...
                ,'dhalfrt', dhalfrt ...
                ...
                ,'thgrMaxLt_out', CalcEdgeAngle(xgrMaxLt_out, ygrMaxLt_out) ...
                ,'grMaxRt_out', grMaxRt_out...
                ,'xgrMaxRt_out', xgrMaxRt_out ...
                ,'ygrMaxRt_out', ygrMaxRt_out ...
                ,'thgrMaxRt_out', CalcEdgeAngle(xgrMaxRt_out, ygrMaxRt_out) ...
